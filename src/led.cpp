...
struct CRGB *upVerticals[] = {
    CRGBSet(leds2, 0, NUM_LEDS_PER_STRIP), 
    CRGBSet(leds5, 0, NUM_LEDS_PER_STRIP),
    CRGBSet(leds3, NUM_LEDS_PER_STRIP * 2, NUM_LEDS_PER_STRIP),
    CRGBSet(leds6, NUM_LEDS_PER_STRIP * 2, NUM_LEDS_PER_STRIP),
    CRGBSet(leds4, NUM_LEDS_PER_STRIP * 3, NUM_LEDS_PER_STRIP * 2),
    CRGBSet(leds5, NUM_LEDS_PER_STRIP * 3, NUM_LEDS_PER_STRIP * 2),
    CRGBSet(leds2, NUM_LEDS_PER_STRIP * 4, NUM_LEDS_PER_STRIP * 3),
    CRGBSet(leds6, NUM_LEDS_PER_STRIP * 4, NUM_LEDS_PER_STRIP * 3),
    CRGBSet(leds2, NUM_LEDS_PER_STRIP * 5, NUM_LEDS_PER_STRIP * 4),
    CRGBSet(leds6, NUM_LEDS_PER_STRIP * 5, NUM_LEDS_PER_STRIP * 4),
};
